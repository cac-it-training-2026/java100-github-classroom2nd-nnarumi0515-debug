...
class Retainer extends Samurai {
	...
	@Override
	public boolean equals(Object object) {//equals()でオブジェクトが同じか比較する
		boolean isMatch;
		Retainer retainer = (Retainer) object;//Retainer型にキャスト
		if (this.domain.equals(retainer.domain)) {//文字列が同じか比較
			isMatch = true;//同じならtrue代入
		} else {
			isMatch = false;
		}
		return isMatch;
