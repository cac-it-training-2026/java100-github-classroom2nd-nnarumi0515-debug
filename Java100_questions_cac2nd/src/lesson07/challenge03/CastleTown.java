...
class Retainer extends Samurai {//侍クラス継承
	void getPaid() {//戻り値なしのメソッド設定
...
public class CastleTown {
	...
	public static void main(String[] args) {
		...
		//ここに必要な処理を記述
		Retainer retainer1 = new Retainer();//藩士オブジェクト生成
		retainer1.fight();//侍クラスのメソッド呼び出し
		retainer1.getPaid();//藩士クラスのオブジェクト呼び出し
