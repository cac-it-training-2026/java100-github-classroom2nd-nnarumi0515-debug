...
public class Explorer {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			System.out.println("\n隊長：");
			if (5 <= length && length <= 8) {//ロープの長さが5m以上8ｍ以下の時
				totalLength += length;//totalLengthに入力されたlength加算
			...
			///ここにwhile文を記述する。
		} while (totalLength < fullHeight);//totalLengthよりもfullHeightが大きいとき繰り返し処理に戻る
