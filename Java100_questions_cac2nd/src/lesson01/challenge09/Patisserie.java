...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("シトロンの味　　・・・" + (int) ((250 * citronbuy) / sum2 * 100) + "%");
		System.out.println("ショコラの味　　・・・" + (int) ((280 * chocobuy) / sum2 * 100) + "%");
		System.out.println("ピスターシュの味・・・" + (int) ((320 * pistabuy) / sum2 * 100) + "%");
